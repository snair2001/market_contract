...
# Gotta change account id in json object every time cos I dont know how to pass env variables
...
# near call royalties.evin.testnet nft_mint '{"token_id": "VeryNewToken10", "metadata": {"title": "Testing auctions part 3", "description": "testing out auction bidding and ending I just wrote", "media": "https://images.unsplash.com/photo-1455243629161-1f993797f78d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDZ8aFNQNkp4OHc0WjR8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60"}, "receiver_id": "alice.evin.testnet"}' --accountId $c --amount 0.1
# near call royalties.evin.testnet nft_approve '{"token_id":"VeryNewToken10", "account_id":"auction_market.evin.testnet", "msg":"{\"price\":\"2\",\"is_auction\":false}"}' --accountId alice.evin.testnet --deposit 1
